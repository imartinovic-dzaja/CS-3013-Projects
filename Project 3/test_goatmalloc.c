...
void print_header(node_t *header){
  ...
  fprintf(fp,"Header->size: %lu\n", header->size);
  fprintf(fp,"Header->fwd: %p\n", header->fwd);
  fprintf(fp,"Header->bwd: %p\n", header->bwd);
  fprintf(fp,"Header->is_free: %d\n", header->is_free);
}
...
void test_init_destroy(){
  ...
  fprintf(fp,">> Testing initialization.\n");
...
void test_allocation_basic(){
  ...
  fprintf(fp,">> Testing allocations without the possibility to split. No Frees.\n");
...
void test_allocationfree_placement(){
  ...
  fprintf(fp,">> Testing basic allocation free placement.\n");
...
void test_allocation_withsplits(){
  ...
  fprintf(fp,">>Testing allocations with splits.\n");
...
void test_free_basic(){
  ...
  fprintf(fp,">>Testing frees without coalescing.\n");
  init(page_size);
  size = page_size - sizeof(node_t);
  buff = walloc(size); 
  header = (node_t *)(buff - sizeof(node_t));
...
void test_free_coalescing_case3(){
  ...
  fprintf(fp,">>Testing frees with coalescing. Case 2.\n");
...
void test_free_coalescing_case1(){
  ...
  fprintf(fp,">>Testing frees with coalescing. Case 1.\n");
...
void test_free_coalescing_chains_fwd(){
  ...
  fprintf(fp,">>Testing frees with coalescing chaining\n");
